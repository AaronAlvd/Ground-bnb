        ...
        <div className="div-body">
              ...
              <div className="div-spotReserve">
                <div className="div-spotReserveTop">
                  ...
                  <div className="div-SRT-right">
                      {spot.avgRating && spot.avgRating > 0 ? ( <p className="spotReserve"> 
          ...
          <div className="div-lowerBody">
            <div className="div-lowerBodyTitle">
              {spot.avgRating && spot.avgRating > 0 ? <p className="LB-Reviews"><FontAwesomeIcon className="SD-icon"icon={faStar}/>{spot.avgRating.toFixed(2)}</p> : <p className="LB-Reviews"><FontAwesomeIcon className="SD-icon"icon={faStar}/>New</p>}
